...
| **Área** | Sistema Productora de Videos, Gestión de observaciones | | | |
| **Actor(es):** | Productora General, Responsable de la Etapa, Asistente de Producción | | | |
| **Descripción:** | Los usuarios autorizados agregan observaciones generales o internos en las etapas de los proyectos, facilitando la comunicación y el seguimiento. | | | |
...
| 7. El actor escribe el observacion en el campo de observaciones | Formulario web de observaciones en el panel |
| 8. El actor añade detalles adicionales si corresponde | Campos opcionales para adjuntos o etiquetas del panel|
| 10. El actor confirma y guarda el observacion | Botón de confirmación en la interfaz |
...
|---|---|
| **Precondiciones:** | El usuario está autenticado y tiene permisos para agregar observaciones. |
